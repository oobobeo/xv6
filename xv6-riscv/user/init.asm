...
main(void)
{
  ...
  6e:	88e50513          	addi	a0,a0,-1906 # 8f8 <malloc+0x152>
  ...
  b0:	81450513          	addi	a0,a0,-2028 # 8c0 <malloc+0x11a>
  ...
  d2:	80a50513          	addi	a0,a0,-2038 # 8d8 <malloc+0x132>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	80250513          	addi	a0,a0,-2046 # 8e0 <malloc+0x13a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 572:	3b270713          	addi	a4,a4,946 # 920 <malloc+0x17a>
 ...
 5fc:	380b8b93          	addi	s7,s7,896 # 978 <digits>
 ...
 650:	2cc90913          	addi	s2,s2,716 # 918 <malloc+0x172>
        while(*s != 0){
